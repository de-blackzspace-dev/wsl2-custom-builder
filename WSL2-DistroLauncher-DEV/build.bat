title WSL2-Custom-Distribution-Builder
color 0c

@echo WSL2-Custom Linux Builder started!!

@echo off

set /p distro="Choose on which unix, your build will be based on! > "

@echo %pwd%

set dirx=%pwd%

set /p target="Target-Buildfolder > "
cd %target%
